...
function sendinblueAdminPrepareHead()
{
    ...
    //$this->tabs = array(
    //	'entity:+tabname:Title:@sendinblue:/sendinblue/mypage.php?id=__ID__'
    //); // to add new tab
    //$this->tabs = array(
    //	'entity:-tabname:Title:@sendinblue:/sendinblue/mypage.php?id=__ID__'
    //); // to remove a tab
    complete_head_from_modules($conf, $langs, $object, $head, $h, 'sendinblue');
